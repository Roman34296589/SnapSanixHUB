...
game.StarterGui:SetCore("SendNotification", {
	Title = "SnapSanix Hub V2.4";
	Text = "Hi! Hub Version 2.4 My YT Channel: @Snapsan";
...
w})
 ...
 -- button aimbot
 local Button = CombatTab:CreateButton({
	Name = "Aimbot [Only Sheriff , RightMouseButton,KeyC. is Z,X]",
	Callback = function()
		...
		local Active = false
		local Lock = false
		local Epitaph = 0.180 ---Note: The Bigger The Number, The More Prediction.
 ...
 local Button = CombatTab:CreateButton({
	...
	Callback = function()
		game.StarterGui:SetCore("SendNotification", {
			Title = "SnapSanix Hub";
			Text = " FrontflipKey = C , BackflipKey = V , Infjump = B";
			Icon = "http://www.roblox.com/asset/?id=15076243399";
			Duration = 3;
			Button1 = "Ok"
		})
